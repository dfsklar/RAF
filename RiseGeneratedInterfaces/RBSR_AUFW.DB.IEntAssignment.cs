...
namespace RBSR_AUFW.DB.IEntAssignment
{
    ...
    /// </summary>
    public class IEntAssignment : _6MAR_WebApplication.RISEBASE
    {
        ...
        public int NewEntAssignment(int EntAssignmentSetID, int BusRoleID, int EntitlementID, string Status)
        {
            ...
            OdbcDataReader dri = null; try { dri = cmd.ExecuteReader(); }
            catch (Exception edri) { cmd.Dispose(); DBClose(); throw edri; }
