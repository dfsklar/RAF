<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SAP1251Workspace.aspx.cs" Inherits="_6MAR_WebApplication.WebForm132" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ComponentArt:Menu ID="GridContextMenu" SiteMapXmlFile="menuData1251.xml" ExpandSlide="none"
...
<A href="javascript:MENUACTnewblank();">Add new object...</A>
</TD>
</TR>
</TABLE>
...
<ConditionalFormats>
	<ComponentArt:GridConditionalFormat ClientFilter="DataItem.GetMember('c_u_EditStatus').Value & 4"
			...
			Width="50"
                    ...
                    <ComponentArt:GridColumn DataField="SAPauthobjname" HeadingText="Object"
			FixedWidth="True"
			Width="80"
		     />
                    <ComponentArt:GridColumn 
		        DataField="SAPauthobjdescr" HeadingText="Description" 
			TextWrap="false"
			Width="120"
			/>


                    <ComponentArt:GridColumn DataField="SAPauthfieldname" HeadingText="Field"
			FixedWidth="True"
			Width="80"
		     />
                    <ComponentArt:GridColumn 
		        DataField="SAPauthfielddescr" HeadingText="Description" 
			TextWrap="false"
			Width="120"
			/>
...
-->
	...
	<input type='hidden' id='RoleName' value='<%=Request.Params["RoleName"]%>'>
...
T.c_id,
SAPOBJ.c_u_Name as SAPauthobjname,
SAPOBJ.c_u_Description as SAPauthobjdescr,
SAPFIELD.c_u_Name as SAPauthfieldname,
SAPFIELD.c_u_Description as SAPauthfielddescr,
T.c_u_RangeLow,
T.c_u_RangeHigh,
T.c_u_EditStatus, 
SAPROLE.c_u_Name as SAProlename, 
T.c_r_TcodeAssignmentSet

FROM t_RBSR_AUFW_u_AuthRow1251 T

LEFT OUTER JOIN 
   t_RBSR_AUFW_u_SAProle SAPROLE 
       ON T.c_r_SAProle = SAPROLE.c_id
LEFT OUTER JOIN 
   t_RBSR_AUFW_u_SAPauthField SAPFIELD 
       ON T.c_r_SAPauthField = SAPFIELD.c_id
LEFT OUTER JOIN 
   t_RBSR_AUFW_u_SAPauthObj SAPOBJ
       ON T.c_r_SAPauthObj = SAPOBJ.c_id
...
ORDER BY SAPFIELD.c_u_Name, T.c_u_RangeLow, T.c_u_RangeHigh
...
<div id="JQDLGeditRow" class='JQdialog' title='1251 Editor'>
...
<tr>
<td colspan=2 style='color:#880000'><i>You may modify only the low/high fields.</i><hr/></td>
</tr>

<tr>
<td>Object:</td>
<td>
<input READONLY type='text' ID="DLGCTL_c_u_ObjName"></input>
</td>
</tr>
...
<td>Field:</td>
<td>
<input READONLY type='text' ID="DLGCTL_c_u_FieldName"></input>
</td>
</tr>
...
<td>Low:</td>
<td>
<input size='33' type='text' id='DLGCTL_c_u_RangeLow' value=''></input> 
</td>
</tr>
...
<td>High:</td>
<td>
<input size='33' type='text' id='DLGCTL_c_u_RangeHigh' value=''></input>
</td>
</tr>
