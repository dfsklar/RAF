// DFSKLAR ADDED FEATURE: 
// Child comboboxes now have a HARDWIRED callback function upon end of XML load.
// Hardwired name is: FUNCdhtmlxChildComboOnXmlLoaded
		...
		if(that.getActualValue()=="") { 
			...
			if(_chcombo._xml){
				...
				if(xml){
					...
					_chcombo.loadXML(xml, FUNCdhtmlxChildComboOnXmlLoaded);
				}
