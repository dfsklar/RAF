...
{
  public partial class WebForm125 : AFWACpage
  {
    ...
    {
        string curSubcontractorURL = "export/ReconcileIDM.ashx?mode=rafdump";

        // This was the technique used in 2009-2011.
//        Context.Response.Redirect(curSubcontractorURL);

        // This is a new technique being tried in 2011-Sept:
      ...
      if (this.FileUpload1.HasFile)
        {
          ...
          Context.Response.Redirect("export/ReconcileIDM.ashx?mode=compare" 
                                    + "&showinternal=" + this.CHKincludeInternalRoles.Checked.ToString()
                                    ...
                                    + "&pathidminput=" + Uri.EscapeUriString(pathTempFile));
        }
    }
  }
